...
import com.example.yoonchang.udemyfoody.databinding.FragmentFoodJokeBinding
...
class FoodJokeFragment : Fragment() {
    ...
    private var binding by autoCleared<FragmentFoodJokeBinding>()
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        Log.e("FoodJokeFragment" , "onCreate")
